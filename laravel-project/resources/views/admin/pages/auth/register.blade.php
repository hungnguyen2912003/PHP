            ...
            <div class="p-md-5 p-4 p-lg-0">
                <div class="text-center mb-4">
                    ...
                    <p class="fs-16 text-secondary lh-1-8">
                        ...
                        <a class="text-primary text-decoration-none" href="{{ route('admin.login') }}">
                        Sign In
                        </a>
                    </p>
                </div>
                <form>
                    <div class="mb-20">
                        ...
                        <div class="form-floating">
                            <input class="form-control" id="floatingInput1" placeholder="Enter name *" type="text"/>
                    ...
                    <div class="mb-20">
                        ...
                        <div class="form-floating">
                            <input class="form-control" id="floatingInput2" placeholder="Enter email address *" type="email"/>
