...
@section('content')
    ...
    <form action="{{ route('admin.login.post') }}" method="POST" id="common-form">
        @csrf
        <div class="mb-20">
        ...
        <div class="mb-20">
            <div class="d-flex justify-content-between align-items-center flex-wrap gap-1">
                ...
                <a class="fs-16 text-primary fw-normal text-decoration-none" href="{{ route('admin.forgot-password') }}">
