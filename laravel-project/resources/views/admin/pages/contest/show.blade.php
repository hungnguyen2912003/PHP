    ...
    <div class="main-content-container overflow-hidden">
            ...
            <div class="card border-0 bg-white rounded-10 mb-4 position-relative">
                <div class="position-relative overflow-hidden rounded-10" style="height: 400px">
                    ...
                    <div
                        ...
                        style="
                            background: url('{{ asset($contest->image_url) }}') center/cover
                                no-repeat;
                            filter: blur(30px);
                            transform: scale(1.1);
                            opacity: 0.6;
        ...
        <div class="row">
            <div class="col-lg-12 col-xxl-12 col-xxxl-12">
                <div
                    class="card bg-white border border-white rounded-10 p-20 mb-4 text-center shadow-sm"
                >
                    <!-- Trophy Icon Overlay -->
                    <div class="mb-3">
                    ...
                    <!-- Date Range -->
                    <div
                        class="text-secondary d-flex align-items-center justify-content-center border-top pt-3 mb-4"
                    >
        ...
        <div class="row">
            <div class="col-12 text-center mb-5">
                <a
                    href="{{ route('admin.contests.edit', $contest->id) }}"
                    class="btn btn-primary px-4 fw-normal text-white"
                >
                    {{ __('button.edit') }}
                </a>
                <a
                    href="{{ route('admin.contests.index') }}"
                    class="btn btn-secondary px-4 fw-normal text-white ms-2"
                >
                    {{ __('button.back') }}
                </a>
            </div>
