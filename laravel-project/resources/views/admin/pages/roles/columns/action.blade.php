<div class="d-flex justify-content-end text-nowrap gap-2">
    <a href="{{ route('admin.roles.show', $role->id) }}" class="bg-transparent p-0 border-0 hover-text-primary" data-bs-placement="top" data-bs-title="{{ __('button.view') }}" data-bs-toggle="tooltip">
    <i class="material-symbols-outlined fs-16 fw-normal text-body">visibility</i>
    </a>
    <a href="{{ route('admin.roles.edit', $role->id) }}" class="bg-transparent p-0 border-0 hover-text-success" data-bs-placement="top" data-bs-title="{{ __('button.edit') }}" data-bs-toggle="tooltip">
