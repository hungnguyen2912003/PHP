...
@section('title', __('title.update_height'))

@section('content')
    <div class="main-content-container overflow-hidden">
        <div class="d-flex justify-content-between align-items-center flex-wrap gap-2 mb-4 mt-1">
            <h3 class="mb-0">
                {{ __('title.update_height') }}
            </h3>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb align-items-center mb-0 lh-1">
                    ...
                    <li aria-current="page" class="breadcrumb-item active">
                        <span class="text-secondary">{{ __('title.update_height') }}</span>
                    </li>
                </ol>
            </nav>
        </div>

        <form id="editHeightForm" action="{{ route('admin.heights.update', $height->id) }}" method="POST"
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card bg-white p-20 rounded-10 border border-white mb-4">
                        <h3 class="mb-20">
                            {{ __('section.height_info') }} ({{ $height->user->fullname ?? __('value.unknown') }})
                        </h3>
                        <div class="row">
                            <div class="row g-3">
                                <div class="col-lg-8">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-floating">
                                                <input class="form-control" id="recorded_at" name="recorded_at"
                                                    ...
                                                    value="{{ old('recorded_at', \Carbon\Carbon::parse($height->recorded_at)->format('Y-m-d\TH:i')) }}" />
                                        ...
                                        <div class="col-12">
                                            ...
                                            <div class="form-floating">
                                                <textarea class="form-control" id="notes" name="notes"
                                                    ...
                                                    style="height: 150px; resize: none;">{{ old('notes', $height->notes) }}</textarea>
                                                <label for="notes"><i
                                ...
                                <div class="col-12">
                                    <div class="d-flex gap-2 justify-content-center mt-4">
                                        ...
                                        <a href="{{ route('admin.heights.index') }}"
                ...
                const pond = FilePond.create(inputElement, {
                    ...
                    files: [
                        @if ($height->attachment_url)
                                                    {
                                source: '{{ asset($height->attachment_url) }}',
                                options: {
                                    type: 'local',
                                },
                            }
