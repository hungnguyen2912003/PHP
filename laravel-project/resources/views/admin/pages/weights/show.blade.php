            ...
            <div class="row g-3">
                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                            ...
                            <div class="form-control py-3">
                                ...
                                {{ $weight->user->fullname ?? __('value.unknown') }}
                            </div>
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-control py-3">
                                ...
                                {{ $weight->recorded_at->format(app()->getLocale() == 'vi' ? 'd/m/Y H:i' : (app()->getLocale() == 'ja' ? 'Y/m/d H:i' : 'Y-m-d H:i')) }}
                            </div>
                        </div>
                        <div class="col-12">
                ...
                <div class="col-lg-4">
                    ...
                    <div class="border rounded-3 p-3 h-100 d-flex flex-column align-items-center justify-content-center">
                        @if ($weight->attachment_url)
                            <a href="{{ asset($weight->attachment_url) }}" target="_blank">
                ...
                <div class="col-12">
                    <div class="d-flex gap-2 justify-content-center mt-4">
                        ...
                        <a href="{{ route('admin.weights.index') }}" class="btn btn-danger fw-normal text-white">
                            {{ __('button.back') }}
                        </a>
                    </div>
                </div>
