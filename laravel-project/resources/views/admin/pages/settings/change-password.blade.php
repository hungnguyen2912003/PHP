...
<div class="main-content-container overflow-hidden">
    ...
    <div class="card bg-white border border-white rounded-10 p-20 mb-4">
        <ul class="ps-0 mb-4 list-unstyled d-flex flex-wrap gap-2 gap-lg-3">
            <li>
                <a class="btn btn-primary border-border-color-70 bg-transparent text-secondary fs-16 fw-normal px-3 px-lg-4" href="{{ route('admin.settings.account') }}">{{ __('title.account') }}</a>
            </li>
            <li>
                <a class="btn btn-primary border-primary bg-primary text-white fs-16 fw-normal px-3 px-lg-4" href="{{ route('admin.settings.change-password') }}">{{ __('title.change_password') }}</a>
            </li>
        </ul>
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    <div class="d-flex gap-2 justify-content-center">
                        ...
                        <a href="{{ route('admin.settings.account') }}" class="btn btn-danger fw-normal text-white">{{ __('button.cancel') }}</a>
                    </div>
                </div>
            </div>
        </form>
