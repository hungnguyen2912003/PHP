<div class="d-flex align-items-center justify-content-end gap-2">
    <a href="{{ route('admin.measurements.edit', $id) }}"
        class="btn btn-sm btn-icon border-0 p-0 text-body bg-transparent" data-bs-toggle="tooltip"
        data-bs-placement="top" title="{{ __('button.edit') }}">
        <span class="material-symbols-outlined fs-20">edit</span>
    </a>
    <form action="{{ route('admin.measurements.destroy', $id) }}" method="POST" class="d-inline">
        @csrf
        @method('DELETE')
