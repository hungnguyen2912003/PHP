...
@section('content')
    <div class="main-content-container overflow-hidden">
        ...
        <form
            id="common-form"
            action="{{ route('admin.measurements.update', $measurement->id) }}"
            method="POST"
                            ...
                            <div class="row g-3">
                                <div class="col-lg-8">
                                    <div class="row g-3">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="form-floating">
                                                <input
                                                    ...
                                                    id="recorded_at"
                                                    name="recorded_at"
                                                    placeholder="{{ __('placeholder.recorded_at') }}"
                                                    type="datetime-local"
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="form-floating">
                                                <input
                                                    ...
                                                    id="body_fat"
                                                    name="body_fat"
                                                    placeholder="{{ __('label.body_fat') }}"
                                                    type="number"
                                                    step="0.1"
                                                    value="{{ old('body_fat', $measurement->body_fat) }}"
                                                />
                                                <label for="body_fat">
                                                    <i class="ri-percentage-line"></i>
                                                    {{ __('label.body_fat') }}
                                                </label>
                                            </div>
                                            @error('body_fat')
                                        ...
                                        <div class="col-md-4">
                                            <label class="label fs-16 mb-2">
                                                {{ __('label.fat_free_body_weight') }}
                                            </label>
                                            <div class="form-floating">
                                                <input
                                                    class="form-control"
                                                    id="fat_free_body_weight"
                                                    name="fat_free_body_weight"
                                                    placeholder="{{ __('label.fat_free_body_weight') }}"
                                                    type="number"
                                                    step="0.1"
                                                    value="{{ old('fat_free_body_weight', $measurement->fat_free_body_weight) }}"
                                                />
                                                <label for="fat_free_body_weight">
                                                    <i class="ri-scales-line"></i>
                                                    {{ __('label.fat_free_body_weight') }}
                                                </label>
                                            </div>
                                            @error('fat_free_body_weight')
                                                <div class="text-danger mt-1">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="form-floating">
                                                <input
                                                    ...
                                                    id="muscle_mass"
                                                    name="muscle_mass"
                                                    placeholder="{{ __('label.muscle_mass') }}"
                                                    type="number"
                                                    step="0.1"
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="form-floating">
                                                <input
                                                    ...
                                                    placeholder="{{ __('label.skeletal_muscle_mass') }}"
                                                    type="number"
                                                    step="0.1"
                                                    value="{{ old('skeletal_muscle_mass', $measurement->skeletal_muscle_mass) }}"
                                                />
                                                <label for="skeletal_muscle_mass">
                                                    <i class="ri-pulse-line"></i>
                                                    {{ __('label.skeletal_muscle_mass') }}
                                                </label>
                                            </div>
                                            @error('skeletal_muscle_mass')
                                                <div class="text-danger mt-1">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="form-floating">
                                                <input
                                                    ...
                                                    placeholder="{{ __('label.subcutaneous_fat') }}"
                                                    type="number"
                                                    step="0.1"
                                                    value="{{ old('subcutaneous_fat', $measurement->subcutaneous_fat) }}"
                                                />
                                                <label for="subcutaneous_fat">
                                                    <i class="ri-drop-line"></i>
                                                    {{ __('label.subcutaneous_fat') }}
                                                </label>
                                            </div>
                                            @error('subcutaneous_fat')
                                                <div class="text-danger mt-1">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="form-floating">
                                                <input
                                                    ...
                                                    id="visceral_fat"
                                                    name="visceral_fat"
                                                    placeholder="{{ __('label.visceral_fat') }}"
                                                    type="number"
                                                    step="0.1"
                                                    value="{{ old('visceral_fat', $measurement->visceral_fat) }}"
                                                />
                                                <label for="visceral_fat">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="form-floating">
                                                <input
                                                    ...
                                                    id="body_water"
                                                    name="body_water"
                                                    placeholder="{{ __('label.body_water') }}"
                                                    type="number"
                                                    step="0.1"
                                                    value="{{ old('body_water', $measurement->body_water) }}"
                                                />
                                                <label for="body_water">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="form-floating">
                                                <input
                                                    ...
                                                    id="bone_mass"
                                                    name="bone_mass"
                                                    placeholder="{{ __('label.bone_mass') }}"
                                                    type="number"
                                                    step="0.1"
            ...
            if (inputElement) {
                ...
                document.getElementById('common-form').addEventListener('submit', function () {
                    ...
                    if (files.length && files[0].origin === FilePond.FileOrigin.LOCAL) {
                        this.querySelectorAll('input[name="attachment"]').forEach(el => el.disabled = true);
                    }
                });
            }
        });
