                ...
                <form id="importForm" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="modal-body pt-3">
                        <div>
                            ...
                            <input type="file" name="file" class="import-file-filepond" accept=".xlsx,.xls,.csv" required>
                        </div>
                    ...
                    <div class="modal-footer border-0 pt-4 d-flex justify-content-between">
                        ...
                        <button type="submit" id="importSubmitBtn"
                            class="btn btn-primary text-white px-4 rounded-3 shadow-sm">
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            if (searchInput) {
                searchInput.addEventListener('keyup', function () {
                    window.LaravelDataTables["admin-measurement-table"].search(this.value).draw();
                });
            }
            ...
            document.body.addEventListener('click', function (e) {
                if (e.target.closest('.import-btn')) {
                    ...
                    // Update form action URL point to measurements import
                    importForm.action = `/admin/measurements/import/${userId}`;
