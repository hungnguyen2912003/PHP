...
<head>
    ...
    <link rel="shortcut icon" href="{{ asset('assets/admin/main/main/img/favicon.png') }}">
    <link href="https://fonts.googleapis.com/css2?family=Roboto:ital,wght@0,400;0,500;0,700;0,900;1,400;1,500;1,700&display=swap"rel="stylesheet">
    <link rel="stylesheet" href="{{ asset('assets/admin/main/plugins/bootstrap/css/bootstrap.min.css') }}">
    <link rel="stylesheet" href="{{ asset('assets/admin/main/plugins/feather/feather.css') }}">
...
<body>
    ...
    <script src="{{ asset('assets/admin/main/js/jquery-3.6.0.min.js') }}"></script>
    <script src="{{ asset('assets/admin/main/plugins/bootstrap/js/bootstrap.bundle.min.js') }}"></script>
    <script src="{{ asset('assets/admin/main/js/feather.min.js') }}"></script>
