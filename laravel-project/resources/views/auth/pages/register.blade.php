...
@section('content')
    <div class="container-fluid bg-cover-register">
                ...
                <div class="card bg-white border rounded-10 border-white py-100 px-130 position-relative">
                    ...
                    <div class="p-md-5 p-4 p-lg-0">
                        ...
                        <form action="{{ route('register.post') }}" method="POST" id="registerForm">
                            @csrf
                            <div class="mb-20">
                                <label class="label fs-16 mb-2">{{ __('messages.full_name') }} <span class="text-danger">*</span></label>
                                <div class="form-floating">
                                    <input class="form-control @error('fullname') is-invalid @enderror" name="fullname"
                                        id="fullname" placeholder="{{ __('messages.enter_full_name') }}" type="text"
                                        value="{{ old('fullname') }}" />
                                    <label for="fullname"><i class="ri-user-line mr-2"></i> {{ __('messages.enter_full_name') }}</label>
                                </div>
                                @error('fullname')
                            ...
                            <div class="mb-20">
                                ...
                                <div class="form-floating">
                                    <input class="form-control @error('username') is-invalid @enderror" name="username"
                                        id="username" placeholder="{{ __('messages.enter_username') }}" type="text"
                                        value="{{ old('username') }}" />
                            ...
                            <div class="mb-20">
                                ...
                                <div class="form-floating">
                                    <input class="form-control @error('email') is-invalid @enderror" name="email" id="email"
                                        placeholder="{{ __('messages.enter_email') }}" type="email" value="{{ old('email') }}" />
                            ...
                            <div class="mb-20">
                                <label class="label fs-16 mb-2">{{ __('messages.password_label') }} <span class="text-danger">*</span></label>
                                <div class="form-group" id="password-show-hide">
                                    <div class="password-wrapper position-relative password-container form-floating">
                                        <input
                                            ...
                                            name="password" id="password" placeholder="{{ __('messages.enter_password') }}" type="password" />
                                        <label for="password"><i class="ri-lock-line mr-2"></i> {{ __('messages.enter_password') }}</label>
                                        <i aria-hidden="true"
                            ...
                            <div class="mb-20">
                                <label class="label fs-16 mb-2">{{ __('messages.confirm_new_password') }} <span class="text-danger">*</span></label>
                                <div class="form-group" id="password-show-hide">
                                    <div class="password-wrapper position-relative password-container form-floating">
                                        <input
                                            class="form-control text-secondary password @error('password_confirmation') is-invalid @enderror"
                                            name="password_confirmation" id="password_confirmation"
                                            placeholder="{{ __('messages.enter_confirm_password') }}" type="password" />
                                        <label for="password_confirmation"><i class="ri-lock-line mr-2"></i> {{ __('messages.enter_confirm_password') }}</label>
                                        <i aria-hidden="true"
                                            class="ri-eye-off-line password-toggle-icon translate-middle-y top-50 position-absolute cursor text-secondary"
                                            style="color: #A9A9C8; font-size: 22px; right: 15px; z-index: 10;">
                                        </i>
