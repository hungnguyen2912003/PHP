        ...
        <div class="col-xxl-6 col-xxxl-12">
            <div class="row">
                ...
                <div class="card bg-white p-20 rounded-10 border border-white mb-4">
                    ...
                    <div id="profit_chart" style="margin-bottom: -17px;">
                    </div>
                </div>
                </div>
                <div class="col-lg-6">
                <div class="card bg-white p-20 rounded-10 border border-white mb-4">
                    ...
                    <div id="average_daily_sales_chart" style="margin-bottom: -17px;">
                    </div>
                </div>
                </div>
                <div class="col-md-6">
                <div class="card p-20 bg-light-40 rounded-10 border-light-40 mb-4 position-relative z-1">
                    ...
                    <h3 class="mb-12 text-primary-50">
                        Michael Marquez!
                    </h3>
                    <h2 class="lh-1 fs-26 fw-medium">
                        $3.5K
                        <span class="fs-16 text-body">
                        (Sales)
                        </span>
                    </h2>
                    <a class="fw-medium fs-16 text-secondary hover-text d-inline-block" href="#" style="margin-top: 84px;">
                    Details View
                    </a>
                    <img alt="man" class="position-absolute bottom-0 end-0 pe-3" src="assets/images/man.png"/>
                </div>
                </div>
                <div class="col-md-6">
                <div class="card p-20 bg-white rounded-10 border border-white mb-4 position-relative z-1">
                    ...
                    <div style="margin-top: 55px;">
                        ...
                        <ul class="p-0 mb-0 list-unstyled d-flex last-child-none global-right-list">
                            ...
                            <img alt="user12" class="border border-3 border-white rounded-circle" src="assets/images/user12.jpg" style="width: 52px; height: 52px;"/>
                            </li>
                            <li style="margin-right: -20px;">
                            <img alt="user13" class="border border-3 border-white rounded-circle" src="assets/images/user13.jpg" style="width: 52px; height: 52px;"/>
                            </li>
                            <li style="margin-right: -20px;">
                            <img alt="user14" class="border border-3 border-white rounded-circle" src="assets/images/user14.jpg" style="width: 52px; height: 52px;"/>
                            </li>
                            <li style="margin-right: -20px;">
                            <img alt="user15" class="border border-3 border-white rounded-circle" src="assets/images/user15.jpg" style="width: 52px; height: 52px;"/>
                            </li>
                            <li style="margin-right: -20px;">
                            <img alt="user16" class="border border-3 border-white rounded-circle" src="assets/images/user16.jpg" style="width: 52px; height: 52px;"/>
                            </li>
                            ...
                            <span class="text-white fs-16 fw-medium">
                            27
                            </span>
                            </li>
                        </ul>
                ...
                <div class="table-responsive">
                    <table class="table align-middle">
                        <tbody>
                            ...
                            <td class="ps-0">
                                <a class="d-flex align-items-center text-decoration-none" href="product-details.html">
                                    <div class="flex-shrink-0">
                                        <img alt="product1" class="rounded-circle" src="assets/images/product1.png" style="width: 50px; height: 50px;"/>
                                    </div>
                            ...
                            <td class="ps-0">
                                <a class="d-flex align-items-center text-decoration-none" href="product-details.html">
                                    <div class="flex-shrink-0">
                                        <img alt="product2" class="rounded-circle" src="assets/images/product2.png" style="width: 50px; height: 50px;"/>
                                    </div>
                                    <div class="flex-grow-1 ms-12">
                                        <h3 class="fw-normal hover-text">
                                        Mobile Phone
                            ...
                            <td class="ps-0">
                                <a class="d-flex align-items-center text-decoration-none" href="product-details.html">
                                    <div class="flex-shrink-0">
                                        <img alt="product3" class="rounded-circle" src="assets/images/product3.png" style="width: 50px; height: 50px;"/>
                                    </div>
                                    <div class="flex-grow-1 ms-12">
                                        <h3 class="fw-normal hover-text">
                                        Laptop Device
                            ...
                            <td class="ps-0">
                                <a class="d-flex align-items-center text-decoration-none" href="product-details.html">
                                    <div class="flex-shrink-0">
                                        <img alt="product4" class="rounded-circle" src="assets/images/product4.png" style="width: 50px; height: 50px;"/>
                                    </div>
                                    <div class="flex-grow-1 ms-12">
                                        <h3 class="fw-normal hover-text">
                                        Black T-Shirt
                            ...
                            <td class="ps-0">
                                <a class="d-flex align-items-center text-decoration-none" href="product-details.html">
                                    <div class="flex-shrink-0">
                                        <img alt="product5" class="rounded-circle" src="assets/images/product5.png" style="width: 50px; height: 50px;"/>
                                    </div>
                                    <div class="flex-grow-1 ms-12">
                                        <h3 class="fw-normal hover-text">
                                        Headphones
                            ...
                            <td class="ps-0">
                                <a class="d-flex align-items-center text-decoration-none" href="product-details.html">
                                    <div class="flex-shrink-0">
                                        <img alt="product6" class="rounded-circle" src="assets/images/product6.png" style="width: 50px; height: 50px;"/>
                                    </div>
                                    <div class="flex-grow-1 ms-12">
                                        <h3 class="fw-normal hover-text">
                                        Hand Watch
                ...
                <div class="d-flex justify-content-center justify-content-sm-between align-items-center text-center flex-wrap gap-2 showing-wrap pt-15">
                    ...
                    <nav aria-label="Page navigation example" class="custom-pagination">
                        <ul class="pagination mb-0 justify-content-center">
                            <li class="page-item">
                            <button aria-label="Previous" class="page-link icon">
                            ...
                            <li class="page-item">
                            <button aria-label="Next" class="page-link icon">
                            <i class="material-symbols-outlined">
                            east
                            </i>
                            </button>
                        ...
                        <tbody>
                            ...
                            <td class="ps-0">
                                <div class="d-flex align-items-center text-decoration-none">
                                    <div class="flex-shrink-0">
                                        <img alt="user6" class="rounded-circle" src="assets/images/user6.jpg" style="width: 50px; height: 50px;"/>
                                    </div>
                                    <div class="flex-grow-1 ms-12">
                                        <h3 class="fw-normal">
                                        Mark Stjohn
                            ...
                            <td>
                                <ul class="p-0 mb-0 list-unstyled d-flex align-items-center justify-content-end" style="gap: 2px;">
                                    <li>
                                        <i class="ri-star-fill text-warning fs-16">
                                        </i>
                                    </li>
                                    <li>
                                        <i class="ri-star-fill text-warning fs-16">
                            ...
                            <td class="ps-0">
                                <div class="d-flex align-items-center text-decoration-none">
                                    <div class="flex-shrink-0">
                                        <img alt="user7" class="rounded-circle" src="assets/images/user7.jpg" style="width: 50px; height: 50px;"/>
                                    </div>
                                    <div class="flex-grow-1 ms-12">
                                        <h3 class="fw-normal">
                                        Joan Stanley
                            ...
                            <td>
                                <ul class="p-0 mb-0 list-unstyled d-flex align-items-center justify-content-end" style="gap: 2px;">
                                    ...
                                    <li>
                                        <i class="ri-star-half-fill text-warning fs-16">
                                        </i>
                                    </li>
                                    <li>
                                        <span class="fs-14 text-body fw-normal">
                            ...
                            <td class="ps-0">
                                <div class="d-flex align-items-center text-decoration-none">
                                    <div class="flex-shrink-0">
                                        <img alt="user8" class="rounded-circle" src="assets/images/user8.jpg" style="width: 50px; height: 50px;"/>
                                    </div>
                                    <div class="flex-grow-1 ms-12">
                                        <h3 class="fw-normal">
                                        Jacob Bell
                            ...
                            <td>
                                <ul class="p-0 mb-0 list-unstyled d-flex align-items-center justify-content-end" style="gap: 2px;">
                                    ...
                                    <li>
                                        <i class="ri-star-line text-warning fs-16">
                                        </i>
                                    </li>
                                    <li>
                                        <span class="fs-14 text-body fw-normal">
                            ...
                            <td class="ps-0">
                                <div class="d-flex align-items-center text-decoration-none">
                                    <div class="flex-shrink-0">
                                        <img alt="user9" class="rounded-circle" src="assets/images/user9.jpg" style="width: 50px; height: 50px;"/>
                                    </div>
                                    <div class="flex-grow-1 ms-12">
                                        <h3 class="fw-normal">
                                        Donald Bryan
                            ...
                            <td class="ps-0">
                                <div class="d-flex align-items-center text-decoration-none">
                                    <div class="flex-shrink-0">
                                        <img alt="user10" class="rounded-circle" src="assets/images/user10.jpg" style="width: 50px; height: 50px;"/>
                                    </div>
                                    <div class="flex-grow-1 ms-12">
                                        <h3 class="fw-normal">
                                        Kristina Blomquist
                            ...
                            <td class="ps-0">
                                <div class="d-flex align-items-center text-decoration-none">
                                    <div class="flex-shrink-0">
                                        <img alt="user11" class="rounded-circle" src="assets/images/user11.jpg" style="width: 50px; height: 50px;"/>
                                    </div>
                                    <div class="flex-grow-1 ms-12">
                                        <h3 class="fw-normal">
                                        Jeffrey Morrison
        ...
        <div class="col-lg-12 col-xxl-4 col-xxxl-12">
            <div class="row">
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-5 col-sm-6">
                            ...
                            <li class="d-flex align-items-center gap-2 mb-9">
                                <img alt="usa" class="rounded-circle" src="assets/images/usa.png" style="width: 20px; height: 20px;"/>
                                <span class="fs-15">
                                United States
                            ...
                            <li class="d-flex align-items-center gap-2 mb-9">
                                <img alt="china" class="rounded-circle" src="assets/images/china.png" style="width: 20px; height: 20px;"/>
                                <span class="fs-15">
                                China
                                <span class="text-secondary">
                                60%
                            ...
                            <li class="d-flex align-items-center gap-2 mb-9">
                                <img alt="australia" class="rounded-circle" src="assets/images/australia.png" style="width: 20px; height: 20px;"/>
                                <span class="fs-15">
                                Australia
                                <span class="text-secondary">
                                85%
                            ...
                            <li class="d-flex align-items-center gap-2 mb-9">
                                <img alt="germany" class="rounded-circle" src="assets/images/germany.png" style="width: 20px; height: 20px;"/>
                                <span class="fs-15">
                                Germany
                                <span class="text-secondary">
                                75%
                            ...
                            <li class="d-flex align-items-center gap-2 mb-9">
                                <img alt="canada" class="rounded-circle" src="assets/images/canada.png" style="width: 20px; height: 20px;"/>
                                <span class="fs-15">
                                Canada
                                <span class="text-secondary">
                                80%
                            ...
                            <li class="d-flex align-items-center gap-2 mb-9">
                                <img alt="france" class="rounded-circle" src="assets/images/france.png" style="width: 20px; height: 20px;"/>
                                <span class="fs-15">
                                France
                                <span class="text-secondary">
                                65%
                ...
                <div class="card bg-white p-20 rounded-10 border border border-white mb-4">
                    ...
                    <div id="revenue_chart" style="margin-bottom: -17px;">
                    </div>
                </div>
                </div>
            </div>
                ...
                <div class="table-responsive">
                    <table class="table align-middle">
                        ...
                        <tbody>
                            ...
                            <td>
                                <a class="d-flex align-items-center text-decoration-none" href="customers.html">
                                    <div class="flex-shrink-0">
                                        <img alt="user1" class="rounded-circle" src="assets/images/user1.jpg" style="width: 50px; height: 50px;"/>
                                    </div>
                                    <div class="flex-grow-1 ms-12">
                            ...
                            <td>
                                <div class="d-flex justify-content-end" style="gap: 12px;">
                                    <button class="bg-transparent p-0 border-0" data-bs-placement="top" data-bs-title="View" data-bs-toggle="tooltip">
                                    <i class="material-symbols-outlined fs-16 fw-normal text-primary">
                                    visibility
                                    </i>
                                    </button>
                                    <button class="bg-transparent p-0 border-0 hover-text-danger" data-bs-placement="top" data-bs-title="Delete" data-bs-toggle="tooltip">
                            ...
                            <td>
                                <a class="d-flex align-items-center text-decoration-none" href="customers.html">
                                    <div class="flex-shrink-0">
                                        <img alt="user2" class="rounded-circle" src="assets/images/user2.jpg" style="width: 50px; height: 50px;"/>
                                    </div>
                                    <div class="flex-grow-1 ms-12">
                                        <h3 class="fw-medium hover-text mb-0 fs-16">
                                        Dorothy Young
                            ...
                            <td>
                                <a class="d-flex align-items-center text-decoration-none" href="customers.html">
                                    <div class="flex-shrink-0">
                                        <img alt="user3" class="rounded-circle" src="assets/images/user3.jpg" style="width: 50px; height: 50px;"/>
                                    </div>
                                    <div class="flex-grow-1 ms-12">
                                        <h3 class="fw-medium hover-text mb-0 fs-16">
                                        Greg Woody
                            ...
                            <td>
                                <a class="d-flex align-items-center text-decoration-none" href="customers.html">
                                    <div class="flex-shrink-0">
                                        <img alt="user4" class="rounded-circle" src="assets/images/user4.jpg" style="width: 50px; height: 50px;"/>
                                    </div>
                                    <div class="flex-grow-1 ms-12">
                                        <h3 class="fw-medium hover-text mb-0 fs-16">
                                        Deborah Rosol
                            ...
                            <td>
                                <a class="d-flex align-items-center text-decoration-none" href="customers.html">
                                    <div class="flex-shrink-0">
                                        <img alt="user1" class="rounded-circle" src="assets/images/user5.jpg" style="width: 50px; height: 50px;"/>
                                    </div>
                                    <div class="flex-grow-1 ms-12">
                                        <h3 class="fw-medium hover-text mb-0 fs-16">
                                        Kendall Allen
                ...
                <div class="table-responsive">
                    <table class="table align-middle">
                        <tbody>
                            ...
                            <td class="fw-normal text-success fs-16">
                                +$995
                            </td>
                            </tr>
                            <tr>
                            ...
                            <td class="fw-normal text-danger fs-16">
                                -$1,550
                            </td>
                            </tr>
                            <tr>
