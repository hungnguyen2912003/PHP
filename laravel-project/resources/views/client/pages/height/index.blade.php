...
@section('title', __('title.height_list'))

@section('content')
    <div class="main-content-container overflow-hidden">
        <div class="d-flex justify-content-between align-items-center flex-wrap gap-2 mb-4 mt-1">
            <h3 class="mb-0">{{ __('title.height_list') }}</h3>
        ...
        <div class="card bg-white rounded-10 border border-white mb-4">
            <div class="d-flex justify-content-between align-items-center flex-wrap gap-3 p-20">
                ...
                <div class="d-flex gap-3">
                    <a class="text-decoration-none fs-16 text-primary" href="{{ route('client.height.create') }}">
                    + {{ __('button.add_height') }}
                    </a>
                </div>
            </div>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            if (searchInput) {
                searchInput.addEventListener('keyup', function () {
                    window.LaravelDataTables["heights-table"].search(this.value).draw();
                });
            }
