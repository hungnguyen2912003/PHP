<div class="d-flex justify-content-end text-nowrap gap-2">
    <a href="{{ route('client.height.show', $height->id) }}" class="bg-transparent p-0 border-0 hover-text-primary"
    ...
    <a href="{{ route('client.height.edit', $height->id) }}" class="bg-transparent p-0 border-0 hover-text-success"
