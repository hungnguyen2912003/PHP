            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb align-items-center mb-0 lh-1">
                    ...
                    <li aria-current="page" class="breadcrumb-item active">
                        <a class="text-decoration-none" href="{{ route('client.height.index') }}">
                            <span class="text-body fs-14 hover">{{ __('breadcrumb.height_management') }}</span>
                        </a>
                    </li>
                    <li aria-current="page" class="breadcrumb-item active">
            ...
            <div class="row g-3">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-control py-3">
                                ...
                                {{ \Carbon\Carbon::parse($height->recorded_at)->format('d/m/Y H:i:s') }}
                            </div>
                        </div>
                        <div class="col-12">
                ...
                <div class="col-12">
                    <div class="d-flex gap-2 justify-content-center mt-4">
                        <a href="{{ route('client.height.edit', $height->id) }}"
                            class="btn btn-primary fw-normal text-white">
                            <i class="ri-edit-line"></i> {{ __('button.edit') }}
                        </a>
                        <a href="{{ route('client.height.index') }}" class="btn btn-danger fw-normal text-white">
                            {{ __('button.back') }}
                        </a>
                    </div>
                </div>
