...
@section('title', __('title.measurement_details'))

@section('content')
    <div class="main-content-container overflow-hidden">
        <div class="d-flex justify-content-between align-items-center flex-wrap gap-2 mb-4 mt-1">
            <h3 class="mb-0">
                {{ __('title.measurement_details') }}
            </h3>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb align-items-center mb-0 lh-1">
                    ...
                    <li aria-current="page" class="breadcrumb-item active">
                        <a class="text-decoration-none" href="{{ route('client.measurement.index') }}">
                            <span class="text-body fs-14 hover">{{ __('breadcrumb.measurement_management') }}</span>
                        </a>
                    </li>
                    <li aria-current="page" class="breadcrumb-item active">
                        <span class="text-secondary">{{ __('title.measurement_details') }}</span>
                    </li>
                </ol>
            </nav>
        </div>
            ...
            <div class="row g-3">
                    ...
                    <div class="row g-3">
                        <div class="col-md-4">
                            ...
                            <div class="form-control py-3">
                                <i class="ri-scales-3-line me-1 align-middle"></i>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="form-control py-3">
                                ...
                                {{ \Carbon\Carbon::parse($measurement->recorded_at)->format('d/m/Y H:i:s') }}
                            </div>
                        </div>
                        <div class="col-12">
                            ...
                            <div class="form-control" style="min-height: 150px;">
                                ...
                                {!! nl2br(e($measurement->notes)) ?: '<span class="text-muted">' . __('value.not_available') . '</span>' !!}
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
                    ...
                    <div class="border rounded-3 p-3 h-100 d-flex flex-column align-items-center justify-content-center">
                        @if ($measurement->attachment_url)
                            <img src="{{ asset($measurement->attachment_url) }}" alt="Attachment" class="img-fluid rounded shadow-sm"
                ...
                <div class="col-12">
                    <div class="d-flex gap-2 justify-content-center mt-4">
                        <a href="{{ route('client.measurement.edit', $measurement->id) }}"
                            class="btn btn-primary fw-normal text-white">
                            <i class="ri-edit-line"></i> {{ __('button.edit') }}
                        </a>
                        <a href="{{ route('client.measurement.index') }}" class="btn btn-danger fw-normal text-white">
                            {{ __('button.back') }}
                        </a>
                    </div>
                </div>
