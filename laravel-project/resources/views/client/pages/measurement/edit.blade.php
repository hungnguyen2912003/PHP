...
@section('content')
    <div class="main-content-container overflow-hidden">
        ...
        <form id="editMeasurementForm" action="{{ route('client.measurement.update', $measurement->id) }}" method="POST"
                                        ...
                                        <div class="col-12">
                                            ...
                                            <div class="form-floating">
                                                <textarea class="form-control" id="notes" name="notes"
                                                    ...
                                                    style="height: 150px; resize: none;">{{ old('notes', $measurement->notes) }}</textarea>
                                                <label for="notes"><i
