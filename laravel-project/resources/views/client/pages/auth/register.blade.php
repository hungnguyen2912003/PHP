...
@section('content')
    ...
    <form action="{{ route('client.register.post') }}" method="POST" id="common-form">
        @csrf
        <div class="mb-20">
            ...
            <div class="form-floating">
                <input class="form-control @error('fullname') is-invalid @enderror" name="fullname" id="fullname"
                    placeholder="{{ __('placeholder.full_name') }}" type="text" value="{{ old('fullname') }}" />
                <label for="fullname">
        ...
        <div class="mb-20">
            ...
            <div class="form-floating">
                <input class="form-control @error('username') is-invalid @enderror" name="username" id="username"
                    placeholder="{{ __('placeholder.username') }}" type="text" value="{{ old('username') }}" />
                <label for="username">
                    <i class="ri-user-line"></i>
        ...
        <div class="mb-20">
            ...
            <div class="form-floating">
                <input class="form-control @error('email') is-invalid @enderror" name="email" id="email"
                    placeholder="{{ __('placeholder.email') }}" type="email" value="{{ old('email') }}" />
                <label for="email">
            ...
            <div class="form-group" id="password-show-hide">
                <div class="password-wrapper position-relative password-container form-floating">
                    <input class="form-control text-secondary password @error('password') is-invalid @enderror"
                        name="password" id="password" placeholder="{{ __('placeholder.enter_password') }}"
                        type="password" />
                    <label for="password">
