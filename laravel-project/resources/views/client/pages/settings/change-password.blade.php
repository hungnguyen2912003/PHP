...
@section('content')
    ...
    <div class="main-content-container overflow-hidden">
        <div class="d-flex justify-content-between align-items-center flex-wrap gap-2 mb-4 mt-1">
            <h3 class="mb-0">{{ __('title.change_password') }}</h3>
            </h3>
            ...
            <ul class="ps-0 mb-4 list-unstyled d-flex flex-wrap gap-2 gap-lg-3">
                ...
                <li>
                    <a class="btn btn-primary border-primary bg-primary text-white fs-16 fw-normal px-3 px-lg-4"
                        href="{{ route('client.settings.change-password') }}">{{ __('title.change_password') }}</a>
                </li>
            </ul>
            <form action="{{ route('client.settings.change-password.update') }}" method="POST" id="password-show-hide">
                @csrf
                <div class="row">
                    <div class="col-lg-4">
                        <div class="mb-20">
                            ...
                            <div class="form-group">
                                <div class="password-wrapper position-relative password-container">
                                    <input name="current_password"
                                        class="form-control text-secondary password @error('current_password') is-invalid @enderror"
                                        placeholder="{{ __('placeholder.current_password') }}" type="password" />
                                    <i aria-hidden="true"
                            ...
                            <div class="form-group">
                                <div class="password-wrapper position-relative password-container">
                                    <input name="new_password"
                                        class="form-control text-secondary password @error('new_password') is-invalid @enderror"
                                        placeholder="{{ __('placeholder.new_password') }}" type="password" />
                                    <i aria-hidden="true"
                                        class="ri-eye-off-line password-toggle-icon translate-middle-y top-50 position-absolute cursor text-secondary"
                                        style="color: #A9A9C8; font-size: 22px; right: 15px;">
                                    </i>
                            ...
                            <div class="form-group">
                                <div class="password-wrapper position-relative password-container">
                                    <input name="new_password_confirmation"
                                        class="form-control text-secondary password @error('new_password_confirmation') is-invalid @enderror"
