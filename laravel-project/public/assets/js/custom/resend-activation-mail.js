document.addEventListener('DOMContentLoaded', function () {
    ...
    function stopCooldown() {
        ...
        if (btnTextActivation) {
             const originalText = btnTextActivation.getAttribute('data-original-text');
             btnTextActivation.innerText = originalText || 'Activate your account';
        }
    }
    ...
    if (form) {
        form.addEventListener('submit', function (e) {
            ...
            localStorage.setItem(STORAGE_KEY, endTime.toString());
             ...
             const sendingText = btnTextActivation ? btnTextActivation.getAttribute('data-sending-text') : 'Sending...';

            // Show loading state immediately
            setTimeout(function() {
                if (submitBtn) submitBtn.disabled = true;
                if (btnTextActivation) btnTextActivation.innerText = sendingText;
